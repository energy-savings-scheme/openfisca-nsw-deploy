...
RUN python -m pip install ./openfisca_nsw_ess_nabers --use-deprecated=legacy-resolver
RUN python -m pip install ./openfisca_nsw_ess_heer --use-deprecated=legacy-resolver
